...
function hackeryou_scripts() {
  ...
  wp_enqueue_script(
    'cookie', //handle
    get_template_directory_uri() . '/js/jquery-cookie/src/jquery.cookie.js', //source
    false, //dependencies
    null, // version number
    true //load in footer
  );
  ...
  wp_enqueue_script(
    'cookie', //handle
    get_template_directory_uri() . '/js/interaction-helper.js', //source
    false, //dependencies
    null, // version number
    true //load in footer
  );
  ...
  wp_enqueue_script(
    'drawSVG', //handle
    get_template_directory_uri() . '/lib/gsap-club/src/minified/plugins/DrawSVGPlugin.min.js', //source
    false, //dependencies
    null, // version number
    true //load in footer
  );
